...
function add(num1, num2){
 let num1Conv =parseInt(num1)
 let num2Conv =parseInt(num2)
...
function nameCheck(param){
  ...
  if (param === name1){
    ...
    return console.log("(called) passing in an argument")
  }
}
...
function faveColorFinder(color){
 ...
 return  console.log(color.String+"you need to evaluate your favorite color choice")
}
}
...
let emailTest = emailCheck("abcde@gmail.com");
